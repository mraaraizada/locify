...
function createPeer(userToSignal, callerID) {
    ...
    peer.on("connect", () => {
        console.log("Peer connection established (createPeer - public)");
        setConnection(true);
    });

    peer.on("error", (err) => {
        console.error("Peer error (createPeer - public):", err);
    });
...
function addPeer(incomingSignal, callerID) {
    ...
    peer.on("connect", () => {
        console.log("Peer connection established (addPeer - public)");
        setConnection(true);
    });

    peer.on("error", (err) => {
        console.error("Peer error (addPeer - public):", err);
    });
